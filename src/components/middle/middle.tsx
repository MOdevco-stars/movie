  ...
  return (
    <div className="bg-[#000000] 2xl:h-[100vh] base:h-[100%] base:pb-[30px] md:pb-0 overflow-hidden">
      <div className="header">
        ...
        <label className="input input-bordered flex items-center gap-2 base:w-[200px]">
          <svg
      ...
      <div className='base:flex justify-between items-center md:hidden w-[95%] m-auto pt-[20px] '>
        <div className="drawer position-relative z-[9999]">
          ...
          <div className="drawer-side">
            ...
            <ul className="menu p-4 w-80 min-h-full flex flex-col gap-6 bg-base-200 text-base-content bg-black">
              {/* Sidebar content here */}
              <h1 className="text-white text-[25px] font-[800]">Movies</h1>
              <div className=''>
              <h1 className=" text-[25px] font-[800] text-[#F8B319]">Tv Shows</h1>
              <div className=' w-[120px] mt-2 h-[4px] rounded-[92px] bg-[#F8B319]'></div>
              </div>
              <h1 className="text-white text-[25px] font-[800]">Anime</h1>
      ...
      <div className='md:w-[80%] base:w-[95%] m-auto md:pt-[60px] base:pt-[50px]'>
        <Link href={'/movie'}>
